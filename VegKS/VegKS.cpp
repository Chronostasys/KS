...
extern "C"{
    ...
    DllExport int SumSize(PrimaryNode* p, char id) {
        auto plist1 = PrimaryList();
        plist1.head->nextVegClass = p;
        p->prevVegClass = plist1.head;
        int sumSize=0;
    ...
    DllExport float SumWeight(PrimaryNode* p, char id) {
        auto plist1 = PrimaryList();
        plist1.head->nextVegClass = p;
        p->prevVegClass = plist1.head;
        float sumSize = 0;
